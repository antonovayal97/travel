...
export function Button({
  ...
  const styles = cn(
    ...
    variant === 'primary' &&
      'bg-[var(--color-accent)] text-white hover:bg-[var(--color-accent-hover)] hover:-translate-y-0.5',
    variant === 'secondary' &&
      'bg-white text-[var(--color-charcoal)] border border-white/80 hover:bg-[var(--color-sand)]',
    variant === 'outline' &&
